        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="mb-16 landing-glass rounded-xl p-8">
            ...
            <div className="flex justify-center space-x-8">
              <img src="/api/placeholder/100/30" alt="Product Hunt" className="h-8 opacity-50 hover:opacity-100 transition-opacity" />
              <img src="/api/placeholder/100/30" alt="Beta List" className="h-8 opacity-50 hover:opacity-100 transition-opacity" />
              <img src="/api/placeholder/100/30" alt="CXL" className="h-8 opacity-50 hover:opacity-100 transition-opacity" />
              <img src="/api/placeholder/100/30" alt="Lemonstand" className="h-8 opacity-50 hover:opacity-100 transition-opacity" />
              <img src="/api/placeholder/100/30" alt="LiveChat" className="h-8 opacity-50 hover:opacity-100 transition-opacity" />
            </div>
          </div>

          {/* <!-- Template Previews --> */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="landing-glass p-4 rounded-lg">
              <img src="/api/placeholder/350/500" alt="Template 1" className="w-full rounded-lg mb-4" />
              <p className="text-lg font-semibold">Get your app now</p>
            </div>
            <div className="landing-glass p-4 rounded-lg">
              <img src="/api/placeholder/350/500" alt="Template 2" className="w-full rounded-lg mb-4" />
              <p className="text-lg font-semibold">Get your app now</p>
            </div>
            <div className="landing-glass p-4 rounded-lg">
              <img src="/api/placeholder/350/500" alt="Template 3" className="w-full rounded-lg mb-4" />
              <p className="text-lg font-semibold">Get your app now</p>
            </div>
            <div className="landing-glass p-4 rounded-lg">
              <img src="/api/placeholder/350/500" alt="Template 4" className="w-full rounded-lg mb-4" />
              <p className="text-lg font-semibold">Get your app now</p>
            </div>
            <div className="landing-glass p-4 rounded-lg">
              <img src="/api/placeholder/350/500" alt="Template 5" className="w-full rounded-lg mb-4" />
              <p className="text-lg font-semibold">Get your app now</p>
            </div>
            <div className="landing-glass p-4 rounded-lg">
              <img src="/api/placeholder/350/500" alt="Template 6" className="w-full rounded-lg mb-4" />
              <p className="text-lg font-semibold">Get your app now</p>
            </div>
          </div>
        </div>
