...
export default function Signup11() {
    return (
        <main className="bg-[#FFE14C] text-black min-h-screen flex items-center justify-center p-4 font-sans">
            <div className="bg-white border-4 border-black rounded-none shadow-neo p-2 px-8 w-full max-w-md relative" style={{ transform: 'rotate(-1deg)' }}>
                <div className="absolute -top-4 -left-4 bg-[#d190ff] border-4 border-black py-2 px-4 font-bold transform rotate-6">
                    Sign up Now!
                </div>
                ...
                <div className="text-center mb-8 mt-6">
                    ...
                    <p className="text-gray-700 mt-2">Create your account to join</p>
                </div>
                ...
                <form>
                    <div className="mb-4">
                        ...
                        <input type="name" id="name" name="name" className="w-full p-3 border-4 border-black rounded-none focus:outline-none focus:ring-4 focus:ring-[#FF90E8]" placeholder="Enter your full name" />
                    </div>
                    <div className="mb-4">
                ...
                <p className="mt-8 text-lg text-center font-bold">
                    Already have an account? <Link href="login-11" className="text-[#23A094] hover:underline">Login</Link>
                </p>
            </div>
        </main>
    )
