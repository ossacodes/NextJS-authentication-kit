            ...
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
                ...
                <form>
                    <div className="mb-4">
                        ...
                        <input className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="username" placeholder="Enter your username..." type="text" />
                    </div>
                    <div className="mb-4">
                        <label className="block text-gray-700 mb-2" htmlFor="email">
                            E-Mail Address
                ...
                <div className="text-center mt-6">
                    <p className="text-gray-600">
                        ...
                        <Link className="text-blue-500 ml-1" href="/auth/login-5">
                            Login
                        </Link>
                    </p>
                </div>
