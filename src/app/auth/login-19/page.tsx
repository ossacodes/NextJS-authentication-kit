...
export default function Login19() {
    return (
            ...
            <div className="w-full max-w-4xl bg-white border-4 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 p-8 bg-blue-400">
                        <h2 className="text-2xl mb-6 text-black" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>LOG IN NOW!</h2>
                        ...
                        <p className="mt-8 text-center text-black text-sm font-bold">
                            NO ACCOUNT?
                            <Link href="signup-19" className="ml-1 underline">CREATE ONE NOW!</Link>
                        </p>
                    </div>
                </div>
            </div>
