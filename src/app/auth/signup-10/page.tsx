            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-md">
                ...
                <form>
                    <div className="mb-4">
                        ...
                        <input type="name" id="name" name="name" className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent" placeholder="Enter your full name" />
                    </div>
                    <div className="mb-4">
                ...
                <p className="mt-8 text-sm text-center">
                    Already have an account? <Link href="login-10" className="text-[#7C3AED] font-semibold hover:underline">Login</Link>
                </p>
            </div>
        </main>
    )
