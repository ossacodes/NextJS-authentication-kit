            ...
            <div className="w-full text-black max-w-md bg-white border-4 border-black">
                ...
                <div className="p-6">
                    <div className="mb-6 text-center">
                        ...
                        <p className="mt-2 text-sm">Create your account to start</p>
                    </div>
                    ...
                    <form>
                        <div className="mb-4">
                            ...
                            <input type="name" id="name" name="name" className="w-full p-2 border-2 border-black focus:outline-none focus:ring-2 focus:ring-black text-sm" placeholder="Enter your full name" />
                        </div>
                        <div className="mb-4">
                    ...
                    <p className="mt-6 text-xs text-center">
                        Already have an account? <Link href="login-12" className="font-bold underline">Login</Link>
                    </p>
                </div>
            </div>
