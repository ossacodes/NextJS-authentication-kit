...
export default function Signup13() {
            ...
            <div className="p-6 bg-gray-100">
                ...
                <form>
                    <div className="mb-4">
                        ...
                        <input type="text" id="name" name="name" className="w-full p-2 border-2 border-black bg-white text-sm" placeholder="_username"/>
                    </div>
                    <div className="mb-4">
                        <label  className="block text-xs mb-1">EMAIL:</label>
                        <input type="email" id="email" name="email" className="w-full p-2 border-2 border-black bg-white text-sm" placeholder="_email"/>
                    </div>
                    <div className="mb-6">
                ...
                <p className="mt-6 text-xs text-center">
                    Old user? <Link href="login-13" className="text-blue-600 underline">Login</Link>
                </p>
            </div>
        </div>
