        ...
        <div className="h-screen w-screen bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-600 flex items-center justify-center relative overflow-hidden p-4">
            ...
            <div className="relative bg-gray-900 bg-opacity-40 backdrop-blur-xl rounded-3xl p-8 w-full max-w-md shadow-2xl border border-gray-700">
                ...
                <form className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-purple-300 mb-2">Full name</label>
                        <input type="name" id="name" placeholder="Full name" className="w-full bg-gray-800 bg-opacity-50 text-white placeholder-gray-400 rounded-lg py-2 px-4 focus:ring-2 focus:ring-purple-500 outline-none" />
                    </div>
                    <div>
                ...
                <p className="text-gray-400 mt-6 text-center">
                    Already have an account? <Link href="login-22" className="text-purple-400 hover:text-purple-300">Login</Link>
                </p>
            </div>
        </div>
    );
