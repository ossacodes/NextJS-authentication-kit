        ...
        <main className="bg-gray-100 flex items-center justify-center min-h-screen p-4">
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden max-w-4xl w-full">
                <div className="flex flex-col md:flex-row">
                    {/* <!-- Image Section --> */}
                    <div className="md:w-1/2 bg-gradient-to-br from-[#8A4FFF] to-[#63f7ef] p-8 flex items-center justify-center">
                        <div className="text-white text-center">
                            <h2 className="text-3xl font-bold mb-4">Welcome to MdUI</h2>
                            <p className="mb-6">Unleash your creativity with our innovative design tools</p>
                    ...
                    <div className="md:w-1/2 p-8 text-black">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <span className="text-sm text-gray-600">Already a member? <Link href="login-7" className="text-[#8A4FFF] font-semibold hover:underline">Sign in</Link></span>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex space-x-4">
                                <input type="text" placeholder="First name" className="w-1/2 p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8A4FFF] focus:border-transparent" />
                                <input type="text" placeholder="Last name" className="w-1/2 p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8A4FFF] focus:border-transparent" />
                            </div>
                            ...
                            <input type="password" placeholder="Create a password" className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8A4FFF] focus:border-transparent" />
                        </div>
                        ...
                        <p className="text-xs text-gray-500 mt-4 text-center">
                            By signing up, you agree to our <a href="#" className="text-[#8A4FFF] hover:underline">Terms of Service</a> and <a href="#" className="text-[#8A4FFF] hover:underline">Privacy Policy</a>
                        </p>
                    </div>
                </div>
            </div>
