            ...
            <div className="flex flex-col w-full max-w-4xl overflow-hidden bg-white shadow-2xl rounded-xl md:flex-row">
                <div className="w-full p-8 md:w-1/2 md:p-12">
                    ...
                    <form className="space-y-6 text-black">
                        ...
                        <button type="submit" className="w-full py-3 text-white transition bg-black rounded-lg shadow-md bg-gradient-to-r hover:bg-slate-800">Sign in</button>
                    </form>
                    <p className="mt-8 text-sm text-center text-gray-600">
                        Don&apos;t have an account? <Link href="signup-4" className="font-medium text-purple-600 transition hover:text-purple-500">Sign up</Link>
                    </p>
                </div>
