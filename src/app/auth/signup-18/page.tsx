...
export default function Signup18() {
    return (
            ...
            <div style={{
                ...
                <div className="w-full md:w-1/2 p-8 flex items-center justify-center bg-black bg-opacity-20">
                    <div className="text-white text-center">
                        ...
                        <h2 className="text-3xl font-bold mb-2">S Money</h2>
                ...
                <div className="w-full md:w-1/2 p-8 glassmorphism18">
                    ...
                    <form className="space-y-6">
                        <div>
                            <input type="text" placeholder="Full name" className="w-full px-4 py-3 rounded-lg glassmorphism18 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8B5CF6]" />
                        </div>
                        <div>
                    ...
                    <p className="mt-8 text-center text-gray-400 text-sm">
                        ...
                        <Link href="login-18" className="ml-1 text-[#8B5CF6] font-semibold hover:underline">Login</Link>
                    </p>
                </div>
            </div>
        </main>
