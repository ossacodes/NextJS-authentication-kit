            ...
            <div className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col">
                    ...
                    <form className="space-y-6">
                        ...
                        <button type="submit" className="w-full bg-black text-white py-3 rounded-lg hover:bg-gray-800 transition">Login</button>
                    </form>
                    <div className="mt-8">
                    ...
                    <p className="mt-8 text-center text-sm text-gray-600">
                        Don&apos;t have an account? <Link href="signup-6" className="text-black font-semibold hover:underline">Sign up</Link>
                    </p>
                </div>
            </div>
        </main>
